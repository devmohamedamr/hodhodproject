		...
		<div class="our-menu">
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-md-1 roundcountry mr-5">
                        <a href="">
                            مصري
                        </a>
                    </div>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="food-sec">
							...
							<div class="detail">
								...
								<h6>Special Menu</h6>
								<p>it is a long established fact that a reader will restaurant be distracted.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="food-sec">
							...
							<div class="detail">
								<span class="food-time">CHEF'S CHOICE</span>
								<span class="small-tit">Cinnamon & Spice</span>
								<h6>Antipasto</h6>
								<p>it is a long established fact that a reader will restaurant be distracted.</p>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="food-sec">
							...
							<div class="detail">
								<span class="food-time">DINNER</span>
								<span class="small-tit">Homemade</span>
								<h6>Blackberry Pie</h6>
								<p>it is a long established fact that a reader will restaurant be distracted.</p>
							</div>
						</div>
					</div>
